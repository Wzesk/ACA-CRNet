...
class config():
    #datasets config
    train_datset_dir = "/data/huang/datasets/cloud/RICE2-inpainting/RICE2-train/cloud/"  # The path of the image to be train
    predict_dataset_dir = "/data/huang/datasets/cloud/RICE2-inpainting/RICE2-test/cloud/"  # The path of the image to be predicted in testing
    val_dataset_dir = "/data/huang/datasets/cloud/RICE2-inpainting/RICE2-test/cloud/" # The path of the image to be valid in training
    ...
    net_state_dict_save_dir = './experiments/rice2-models/' # output pth dir
    ...
    net_init = None #'./experiments/pretrained_models/rice2.pth', None
    gpu_ids=[0] #GPU ID
    epoch = 300 #train 300
    lr= 7e-5
